...
function CategoryCard({ image, name, click }: CategoryCardProps) {
  return (
    <div className="relative rounded-md overflow-hidden group h-36" onClick={click}>
...
function CategoryGrid() {
  ...
  return (
    <div className="mx-auto px-4 pb-16">
      <h2 className="text-2xl font-medium text-gray-800 uppercase mb-6">Escolha uma categoria</h2>
